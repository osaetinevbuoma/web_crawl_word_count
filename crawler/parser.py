...
class Parser:
    ...
    the Parser wrapper class is to wrap the functionality of our selected parsing library. This way,
    if in the future there is the need to use a different parsing library, that switch can be done
